  ...
  const bubbleMenuItems = [
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleBold().run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleItalic().run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleUnderline().run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleStrike().run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleCode().run(),

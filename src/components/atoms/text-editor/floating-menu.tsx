...
export function EditorFloatingMenu(props: EditorFloatingMenuProps) {
  ...
  const floatingMenuItems = [
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleHeading({ level: 1 }).run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleHeading({ level: 2 }).run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleHeading({ level: 3 }).run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleBulletList().run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleOrderedList().run(),
    ...
    },
    {
      ...
      command: () => (editor as any)?.chain().focus().toggleCodeBlock().run(),

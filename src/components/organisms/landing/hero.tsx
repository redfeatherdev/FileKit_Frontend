            ...
            >
              <ReactScrollLink
                ...
                className={cn(
                  ...
                  'text-black bg-white hover:bg-white/80 font-medium py-2 px-5 rounded text-xs xl:text-base xl:py-4 xl:px-10 xl:rounded-lg font-medium'
                )}
              >
                Subscribe
              </ReactScrollLink>
              ...
              >
                ...
                <Text as="span" className='font-medium'>Free Trial</Text>
              </Link>
            </Flex>
          </Box>
        </Flex>

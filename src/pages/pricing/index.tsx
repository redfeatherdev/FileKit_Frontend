    ...
    >
      ...
      >
        <Box className="w-full">
          ...
          <div
            className="block mb-2 text-sm lg:text-base text-center bg-custom-black duration-200 hover:bg-custom-black/90 font-semibold rounded md:rounded-lg lg:p-4 p-3 text-white cursor-pointer"
          >
            Get Started
          </div>
